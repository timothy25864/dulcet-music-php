...
<form name="myForm" method="POST" action="course_updateEdit.php" enctype="multipart/form-data">
    <table class="table1">
        <tbody>
        <?php
        //SQL 敘述
        ...
        ?>
            <tr>
                <td class="border" style="white-space:nowrap">商品圖片</td>
                <td class="border">
            ...
            <tr>
                ...
                <td class="border">
                    <input type="text" name="PName"  size="25" value="<?php echo $arr[0]['PName']; ?>" maxlength="10" />
                </td>
            </tr>
            <tr>
